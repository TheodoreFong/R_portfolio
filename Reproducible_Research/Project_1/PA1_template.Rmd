...
```
2. The 5-min interval around 8:15AM has the max number of steps.
...
Estimated missing values by filling with average across all days for the given interval
```{r}
...
Filling the missing values with estimates slightly increased mean and median steps per day.
